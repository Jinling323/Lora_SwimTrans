...
from models.module_consistency_multibatch import LearnableGlobalLocalMultiheadAttention
...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward_post(self,
        ...
        # src:  [source_length, batch, channels]
        # Keep each image independent and aggregate only over source tokens.
        consistent_feature = torch.bmm(mask, src.permute(1, 0, 2))
